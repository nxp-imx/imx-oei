...
#ifndef _MIMX95294_cm33_FEATURES_H_
#define _MIMX95294_cm33_FEATURES_H_
...
#define FSL_FEATURE_SOC_EIM_COUNT (6)
...
#define FSL_FEATURE_SOC_LPSPI_COUNT (9)
...
#define FSL_FEATURE_SOC_MU_COUNT (27)
...
/* NETCMIX module features */
/* @brief Is affected by errata with ID XXXXX (ungated ENET_REF_CLK impacts NETCMIX reset) */
#define FSL_FEATURE_NETCMIX_HAS_ERRATA_XXXXXX (1)
