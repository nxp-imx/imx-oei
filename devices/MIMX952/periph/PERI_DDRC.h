 ...
 *  0b0000, 0b1010..15 for LPDDR4x 19 for LPDDR5
...
#define DDRC_DDR_SDRAM_CFG_6_MR28_VAL_MASK       (0x3FU)
#define DDRC_DDR_SDRAM_CFG_6_MR28_VAL_SHIFT      (0U)
/*! MR28_VAL - MR28 Value. */
#define DDRC_DDR_SDRAM_CFG_6_MR28_VAL(x)         (((uint32_t)(((uint32_t)(x)) << DDRC_DDR_SDRAM_CFG_6_MR28_VAL_SHIFT)) & DDRC_DDR_SDRAM_CFG_6_MR28_VAL_MASK)

#define DDRC_DDR_SDRAM_CFG_6_RRO_MASK            (0x40U)
#define DDRC_DDR_SDRAM_CFG_6_RRO_SHIFT           (6U)
/*! RRO - Refresh rate option. */
#define DDRC_DDR_SDRAM_CFG_6_RRO(x)              (((uint32_t)(((uint32_t)(x)) << DDRC_DDR_SDRAM_CFG_6_RRO_SHIFT)) & DDRC_DDR_SDRAM_CFG_6_RRO_MASK)

#define DDRC_DDR_SDRAM_CFG_6_ADDR_SZL_EN_MASK    (0x1000U)
#define DDRC_DDR_SDRAM_CFG_6_ADDR_SZL_EN_SHIFT   (12U)
 ...
 */
#define DDRC_DDR_SDRAM_CFG_6_ADDR_SZL_EN(x)      (((uint32_t)(((uint32_t)(x)) << DDRC_DDR_SDRAM_CFG_6_ADDR_SZL_EN_SHIFT)) & DDRC_DDR_SDRAM_CFG_6_ADDR_SZL_EN_MASK)

#define DDRC_DDR_SDRAM_CFG_6_RD_SPLT_EN_MASK     (0x2000U)
#define DDRC_DDR_SDRAM_CFG_6_RD_SPLT_EN_SHIFT    (13U)
 ...
 */
#define DDRC_DDR_SDRAM_CFG_6_RD_SPLT_EN(x)       (((uint32_t)(((uint32_t)(x)) << DDRC_DDR_SDRAM_CFG_6_RD_SPLT_EN_SHIFT)) & DDRC_DDR_SDRAM_CFG_6_RD_SPLT_EN_MASK)
/*! @} */

/*! @name DDR_SDRAM_MD_CNTL2 - DDR SDRAM mode control 2 */
/*! @{ */

#define DDRC_DDR_SDRAM_MD_CNTL2_MPRR_MASK        (0x80000000U)
#define DDRC_DDR_SDRAM_MD_CNTL2_MPRR_SHIFT       (31U)
 ...
 */
#define DDRC_DDR_SDRAM_MD_CNTL2_MPRR(x)          (((uint32_t)(((uint32_t)(x)) << DDRC_DDR_SDRAM_MD_CNTL2_MPRR_SHIFT)) & DDRC_DDR_SDRAM_MD_CNTL2_MPRR_MASK)
/*! @} */

/*! @name DDR_SDRAM_MPR4 - DDR SDRAM multi-purpose register 4 */
/*! @{ */

#define DDRC_DDR_SDRAM_MPR4_MPR_READ_MASK        (0xFFFFFFFFU)
#define DDRC_DDR_SDRAM_MPR4_MPR_READ_SHIFT       (0U)
/*! MPR_READ - MPR Read Value. */
#define DDRC_DDR_SDRAM_MPR4_MPR_READ(x)          (((uint32_t)(((uint32_t)(x)) << DDRC_DDR_SDRAM_MPR4_MPR_READ_SHIFT)) & DDRC_DDR_SDRAM_MPR4_MPR_READ_MASK)
/*! @} */

/*! @name DDR_SDRAM_MPR5 - DDR SDRAM multi-purpose register 5 */
/*! @{ */

#define DDRC_DDR_SDRAM_MPR5_MPR_VLD_MASK         (0x1U)
#define DDRC_DDR_SDRAM_MPR5_MPR_VLD_SHIFT        (0U)
/*! MPR_VLD - MPR Valid.
 ...
 */
#define DDRC_DDR_SDRAM_MPR5_MPR_VLD(x)           (((uint32_t)(((uint32_t)(x)) << DDRC_DDR_SDRAM_MPR5_MPR_VLD_SHIFT)) & DDRC_DDR_SDRAM_MPR5_MPR_VLD_MASK)
/*! @} */
...
#define DDRC_TX_CFG_1_HPR_MASK                   (0x200000U)
#define DDRC_TX_CFG_1_HPR_SHIFT                  (21U)
 ...
 */
#define DDRC_TX_CFG_1_HPR(x)                     (((uint32_t)(((uint32_t)(x)) << DDRC_TX_CFG_1_HPR_SHIFT)) & DDRC_TX_CFG_1_HPR_MASK)
/*! @} */

/*! @name TX_CFG_2 - Transaction Configuration Register 2 */
/*! @{ */

#define DDRC_TX_CFG_2_WR_BONUS_MASK              (0x1FU)
#define DDRC_TX_CFG_2_WR_BONUS_SHIFT             (0U)
/*! WR_BONUS - Write Bandwidth Bonus Count. */
#define DDRC_TX_CFG_2_WR_BONUS(x)                (((uint32_t)(((uint32_t)(x)) << DDRC_TX_CFG_2_WR_BONUS_SHIFT)) & DDRC_TX_CFG_2_WR_BONUS_MASK)

#define DDRC_TX_CFG_2_WR_CNT_MASK                (0x1F00U)
#define DDRC_TX_CFG_2_WR_CNT_SHIFT               (8U)
/*! WR_CNT - Write Bandwidth Count. */
#define DDRC_TX_CFG_2_WR_CNT(x)                  (((uint32_t)(((uint32_t)(x)) << DDRC_TX_CFG_2_WR_CNT_SHIFT)) & DDRC_TX_CFG_2_WR_CNT_MASK)

#define DDRC_TX_CFG_2_RD_BONUS_MASK              (0x1F0000U)
#define DDRC_TX_CFG_2_RD_BONUS_SHIFT             (16U)
/*! RD_BONUS - Read Bandwidth Bonus Count. */
#define DDRC_TX_CFG_2_RD_BONUS(x)                (((uint32_t)(((uint32_t)(x)) << DDRC_TX_CFG_2_RD_BONUS_SHIFT)) & DDRC_TX_CFG_2_RD_BONUS_MASK)

#define DDRC_TX_CFG_2_RD_CNT_MASK                (0x1F000000U)
#define DDRC_TX_CFG_2_RD_CNT_SHIFT               (24U)
/*! RD_CNT - Read Bandwidth Count. */
#define DDRC_TX_CFG_2_RD_CNT(x)                  (((uint32_t)(((uint32_t)(x)) << DDRC_TX_CFG_2_RD_CNT_SHIFT)) & DDRC_TX_CFG_2_RD_CNT_MASK)

#define DDRC_TX_CFG_2_RD_EPA_DIS_MASK            (0x40000000U)
#define DDRC_TX_CFG_2_RD_EPA_DIS_SHIFT           (30U)
/*! RD_EPA_DIS - Read Precharge to Activate Disable. */
#define DDRC_TX_CFG_2_RD_EPA_DIS(x)              (((uint32_t)(((uint32_t)(x)) << DDRC_TX_CFG_2_RD_EPA_DIS_SHIFT)) & DDRC_TX_CFG_2_RD_EPA_DIS_MASK)

#define DDRC_TX_CFG_2_WR_EPA_DIS_MASK            (0x80000000U)
#define DDRC_TX_CFG_2_WR_EPA_DIS_SHIFT           (31U)
/*! WR_EPA_DIS - Write Precharge to Activate Disable. */
#define DDRC_TX_CFG_2_WR_EPA_DIS(x)              (((uint32_t)(((uint32_t)(x)) << DDRC_TX_CFG_2_WR_EPA_DIS_SHIFT)) & DDRC_TX_CFG_2_WR_EPA_DIS_MASK)
/*! @} */
...
#define DDRC_ERR_DETECT_ILLTXNE_MASK             (0x10U)
#define DDRC_ERR_DETECT_ILLTXNE_SHIFT            (4U)
 ...
 */
#define DDRC_ERR_DETECT_ILLTXNE(x)               (((uint32_t)(((uint32_t)(x)) << DDRC_ERR_DETECT_ILLTXNE_SHIFT)) & DDRC_ERR_DETECT_ILLTXNE_MASK)
