...
#define SRC_GENERAL_REG_SMRSR_RESET_DOMAIN_FLAG_MASK     (0x7FFFFFFU)
...
/*! RSTR_11 - configuration bit for independent reset of reset region CORTEXAMIX_PLATFORM by event <a>
...
/*! RSTR_15 - configuration bit for independent reset of reset region GPUMIX by event <a>
...
/*! RSTR_18 - configuration bit for independent reset of reset region M7MIX by event <a>
...
/*! RSTR_19 - configuration bit for independent reset of reset region NETCMIX by event <a>
...
/*! RSTR_20 - configuration bit for independent reset of reset region NOCMIX by event <a>
...
/*! RSTR_21 - configuration bit for independent reset of reset region NPUMIX by event <a>
...
/*! RSTR_22 - configuration bit for independent reset of reset region VPUMIX by event <a>
...
/*! RSTR_23 - configuration bit for independent reset of reset region WAKEUPMIX_TOP by event <a>
...
/*! RSTR_24 - configuration bit for independent reset of reset region WAKEUPMIX_JTAG by event <a>
...
/*! RSTR_25 - configuration bit for independent reset of reset region WAKEUPMIX_WDOG_3_4 by event <a>
...
/*! RSTR_11_RDIS - configuration bit to disbale reset of reset region CORTEXAMIX_PLATFORM by reset event
...
/*! RSTR_15_RDIS - configuration bit to disbale reset of reset region GPUMIX by reset event
...
/*! RSTR_18_RDIS - configuration bit to disbale reset of reset region M7MIX by reset event
...
/*! RSTR_19_RDIS - configuration bit to disbale reset of reset region NETCMIX by reset event
...
/*! RSTR_20_RDIS - configuration bit to disbale reset of reset region NOCMIX by reset event
...
/*! RSTR_21_RDIS - configuration bit to disbale reset of reset region NPUMIX by reset event
...
/*! RSTR_22_RDIS - configuration bit to disbale reset of reset region VPUMIX by reset event
...
/*! RSTR_23_RDIS - configuration bit to disbale reset of reset region WAKEUPMIX_TOP by reset event
...
/*! RSTR_24_RDIS - configuration bit to disbale reset of reset region WAKEUPMIX_JTAG by reset event
...
/*! RSTR_25_RDIS - configuration bit to disbale reset of reset region WAKEUPMIX_WDOG_3_4 by reset event
...
#define SRC_GENERAL_REG_RST_CLK_DURATION_CFG_RST_CLK_DURATION_CFG_MASK (0xFFU)
#define SRC_GENERAL_REG_RST_CLK_DURATION_CFG_RST_CLK_DURATION_CFG_SHIFT (0U)
/*! RST_CLK_DURATION_CFG - Reset Clock Duration Configuration Register */
#define SRC_GENERAL_REG_RST_CLK_DURATION_CFG_RST_CLK_DURATION_CFG(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_RST_CLK_DURATION_CFG_RST_CLK_DURATION_CFG_SHIFT)) & SRC_GENERAL_REG_RST_CLK_DURATION_CFG_RST_CLK_DURATION_CFG_MASK)
/*! @} */

/*! @name CDC_RDC_CLKOFF_DURATION_CFG - CDC RDC Clock Off Duration Configuration Register */
/*! @{ */

#define SRC_GENERAL_REG_CDC_RDC_CLKOFF_DURATION_CFG_CDC_RDC_CLKOFF_DURATION_CFG_MASK (0xFFU)
#define SRC_GENERAL_REG_CDC_RDC_CLKOFF_DURATION_CFG_CDC_RDC_CLKOFF_DURATION_CFG_SHIFT (0U)
/*! CDC_RDC_CLKOFF_DURATION_CFG - CDC RDC Clock Off Duration Configuration Register */
#define SRC_GENERAL_REG_CDC_RDC_CLKOFF_DURATION_CFG_CDC_RDC_CLKOFF_DURATION_CFG(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_CDC_RDC_CLKOFF_DURATION_CFG_CDC_RDC_CLKOFF_DURATION_CFG_SHIFT)) & SRC_GENERAL_REG_CDC_RDC_CLKOFF_DURATION_CFG_CDC_RDC_CLKOFF_DURATION_CFG_MASK)
/*! @} */

/*! @name DEST_RST_MIN_DURATION_CNT_CFG - Reset FSM Destructive Reset Minimum Duration Counter Configuration Register */
/*! @{ */

#define SRC_GENERAL_REG_DEST_RST_MIN_DURATION_CNT_CFG_DEST_RST_MIN_DURATION_CNT_CFG_MASK (0xFFU)
#define SRC_GENERAL_REG_DEST_RST_MIN_DURATION_CNT_CFG_DEST_RST_MIN_DURATION_CNT_CFG_SHIFT (0U)
/*! DEST_RST_MIN_DURATION_CNT_CFG - Reset FSM Destructive Reset Minimum Duration Counter Configuration Register */
#define SRC_GENERAL_REG_DEST_RST_MIN_DURATION_CNT_CFG_DEST_RST_MIN_DURATION_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_DEST_RST_MIN_DURATION_CNT_CFG_DEST_RST_MIN_DURATION_CNT_CFG_SHIFT)) & SRC_GENERAL_REG_DEST_RST_MIN_DURATION_CNT_CFG_DEST_RST_MIN_DURATION_CNT_CFG_MASK)
/*! @} */

/*! @name FUNC_RST_MIN_DURATION_CNT_CFG - Reset FSM Functional Reset Minimum Duration Counter Configuration Register */
/*! @{ */

#define SRC_GENERAL_REG_FUNC_RST_MIN_DURATION_CNT_CFG_FUNC_RST_MIN_DURATION_CNT_CFG_MASK (0xFFU)
#define SRC_GENERAL_REG_FUNC_RST_MIN_DURATION_CNT_CFG_FUNC_RST_MIN_DURATION_CNT_CFG_SHIFT (0U)
/*! FUNC_RST_MIN_DURATION_CNT_CFG - Reset FSM Functional Reset Minimum Duration Counter Configuration Register */
#define SRC_GENERAL_REG_FUNC_RST_MIN_DURATION_CNT_CFG_FUNC_RST_MIN_DURATION_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_FUNC_RST_MIN_DURATION_CNT_CFG_FUNC_RST_MIN_DURATION_CNT_CFG_SHIFT)) & SRC_GENERAL_REG_FUNC_RST_MIN_DURATION_CNT_CFG_FUNC_RST_MIN_DURATION_CNT_CFG_MASK)
/*! @} */

/*! @name RST_EVT_DURATION_CNT_CFG - Reset FSM Reset Event Duration Counter Configuration Register */
/*! @{ */

#define SRC_GENERAL_REG_RST_EVT_DURATION_CNT_CFG_RST_EVT_DURATION_CNT_CFG_MASK (0xFFU)
#define SRC_GENERAL_REG_RST_EVT_DURATION_CNT_CFG_RST_EVT_DURATION_CNT_CFG_SHIFT (0U)
/*! RST_EVT_DURATION_CNT_CFG - Reset FSM Reset Event Duration Counter Configuration Register */
#define SRC_GENERAL_REG_RST_EVT_DURATION_CNT_CFG_RST_EVT_DURATION_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_RST_EVT_DURATION_CNT_CFG_RST_EVT_DURATION_CNT_CFG_SHIFT)) & SRC_GENERAL_REG_RST_EVT_DURATION_CNT_CFG_RST_EVT_DURATION_CNT_CFG_MASK)
/*! @} */

/*! @name MISC_CTRL - Miscellaneous control register */
/*! @{ */

#define SRC_GENERAL_REG_MISC_CTRL_IMX95_CDC_RDC_CLKOFF_MODE_EN_MASK (0x1U)
#define SRC_GENERAL_REG_MISC_CTRL_IMX95_CDC_RDC_CLKOFF_MODE_EN_SHIFT (0U)
/*! IMX95_CDC_RDC_CLKOFF_MODE_EN - Enable CDC RDC Clock Off strategy
 *  0b0..CDC RDC Clock Off strategy disabled
 *  0b1..CDC RDC Clock Off strategy enabled
 */
#define SRC_GENERAL_REG_MISC_CTRL_IMX95_CDC_RDC_CLKOFF_MODE_EN(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_IMX95_CDC_RDC_CLKOFF_MODE_EN_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_IMX95_CDC_RDC_CLKOFF_MODE_EN_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_ANAMIX_MASK (0x2U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_ANAMIX_SHIFT (1U)
/*! MIX_MODE_CTRL_ANAMIX - ANAMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_ANAMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_ANAMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_ANAMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_AONMIX_MASK (0x4U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_AONMIX_SHIFT (2U)
/*! MIX_MODE_CTRL_AONMIX - AONMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_AONMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_AONMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_AONMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_BBSMMIX_MASK (0x8U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_BBSMMIX_SHIFT (3U)
/*! MIX_MODE_CTRL_BBSMMIX - BBSMMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_BBSMMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_BBSMMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_BBSMMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CAMERAMIX_MASK (0x10U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CAMERAMIX_SHIFT (4U)
/*! MIX_MODE_CTRL_CAMERAMIX - CAMERAMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CAMERAMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CAMERAMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CAMERAMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CCMSRCGPCMIX_MASK (0x20U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CCMSRCGPCMIX_SHIFT (5U)
/*! MIX_MODE_CTRL_CCMSRCGPCMIX - CCMSRCGPCMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CCMSRCGPCMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CCMSRCGPCMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CCMSRCGPCMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE0_MASK (0x40U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE0_SHIFT (6U)
/*! MIX_MODE_CTRL_CORTEXAMIX_CORE0 - CORTEXAMIX_CORE0 mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE0(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE0_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE0_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE1_MASK (0x80U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE1_SHIFT (7U)
/*! MIX_MODE_CTRL_CORTEXAMIX_CORE1 - CORTEXAMIX_CORE1 mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE1(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE1_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE1_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE2_MASK (0x100U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE2_SHIFT (8U)
/*! MIX_MODE_CTRL_CORTEXAMIX_CORE2 - CORTEXAMIX_CORE2 mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE2(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE2_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE2_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE3_MASK (0x200U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE3_SHIFT (9U)
/*! MIX_MODE_CTRL_CORTEXAMIX_CORE3 - CORTEXAMIX_CORE3 mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE3(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE3_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE3_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_PLATFORM_MASK (0x400U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_PLATFORM_SHIFT (10U)
/*! MIX_MODE_CTRL_CORTEXAMIX_PLATFORM - CORTEXAMIX_PLATFORM mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_PLATFORM(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_PLATFORM_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_PLATFORM_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_DDRMIX_MASK (0x800U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_DDRMIX_SHIFT (11U)
/*! MIX_MODE_CTRL_DDRMIX - DDRMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_DDRMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_DDRMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_DDRMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_DISPLAYMIX_MASK (0x1000U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_DISPLAYMIX_SHIFT (12U)
/*! MIX_MODE_CTRL_DISPLAYMIX - DISPLAYMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_DISPLAYMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_DISPLAYMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_DISPLAYMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_GPUMIX_MASK (0x2000U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_GPUMIX_SHIFT (13U)
/*! MIX_MODE_CTRL_GPUMIX - GPUMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_GPUMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_GPUMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_GPUMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_TOP_MASK (0x4000U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_TOP_SHIFT (14U)
/*! MIX_MODE_CTRL_HSIOMIX_TOP - HSIOMIX_TOP mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_TOP(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_TOP_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_TOP_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_WAON_MASK (0x8000U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_WAON_SHIFT (15U)
/*! MIX_MODE_CTRL_HSIOMIX_WAON - HSIOMIX_WAON mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_WAON(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_WAON_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_WAON_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_M7MIX_MASK (0x10000U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_M7MIX_SHIFT (16U)
/*! MIX_MODE_CTRL_M7MIX - M7MIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_M7MIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_M7MIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_M7MIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NETCMIX_MASK (0x20000U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NETCMIX_SHIFT (17U)
/*! MIX_MODE_CTRL_NETCMIX - NETCMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NETCMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NETCMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NETCMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NOCMIX_MASK (0x40000U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NOCMIX_SHIFT (18U)
/*! MIX_MODE_CTRL_NOCMIX - NOCMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NOCMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NOCMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NOCMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NPUMIX_MASK (0x80000U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NPUMIX_SHIFT (19U)
/*! MIX_MODE_CTRL_NPUMIX - NPUMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NPUMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NPUMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_NPUMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_VPUMIX_MASK (0x100000U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_VPUMIX_SHIFT (20U)
/*! MIX_MODE_CTRL_VPUMIX - VPUMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_VPUMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_VPUMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_VPUMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_WAKEUPMIX_MASK (0x200000U)
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_WAKEUPMIX_SHIFT (21U)
/*! MIX_MODE_CTRL_WAKEUPMIX - WAKEUPMIX mode control */
#define SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_WAKEUPMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_WAKEUPMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_MIX_MODE_CTRL_WAKEUPMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_HSIOMIX_TOP_MASK (0x400000U)
#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_HSIOMIX_TOP_SHIFT (22U)
/*! DISABLE_SAFE_STATE_HSIOMIX_TOP - Disable CCMSRCGPC handshake with HSIOMIX_TOP
 *  0b0..CCMSRCGPCMIX will handshake wtih HSIOMIX_TOP
 *  0b1..CCMSRCGPCMIX will not handshake wtih HSIOMIX_TOP
 */
#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_HSIOMIX_TOP(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_HSIOMIX_TOP_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_HSIOMIX_TOP_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_NETCMIX_MASK (0x800000U)
#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_NETCMIX_SHIFT (23U)
/*! DISABLE_SAFE_STATE_NETCMIX - Disable CCMSRCGPC handshake with NETCMIX
 *  0b0..CCMSRCGPCMIX will handshake wtih NETCMIX
 *  0b1..CCMSRCGPCMIX will not handshake wtih NETCMIX
 */
#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_NETCMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_NETCMIX_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_NETCMIX_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_3_4_MASK (0x1000000U)
#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_3_4_SHIFT (24U)
/*! DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_3_4 - Disable CCMSRCGPC handshake with WAKEUPMIX_WDOG_3_4
 *  0b0..CCMSRCGPCMIX will handshake wtih WAKEUPMIX_WDOG_3_4
 *  0b1..CCMSRCGPCMIX will not handshake wtih WAKEUPMIX_WDOG_3_4
 */
#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_3_4(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_3_4_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_3_4_MASK)

#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_5_MASK (0x2000000U)
#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_5_SHIFT (25U)
/*! DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_5 - Disable CCMSRCGPC handshake with WAKEUPMIX_WDOG_5
 *  0b0..CCMSRCGPCMIX will handshake wtih WAKEUPMIX_WDOG_5
 *  0b1..CCMSRCGPCMIX will not handshake wtih WAKEUPMIX_WDOG_5
 */
#define SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_5(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_5_SHIFT)) & SRC_GENERAL_REG_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_5_MASK)
/*! @} */
