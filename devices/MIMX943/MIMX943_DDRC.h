 ...
 * @version
 * @date
 * @brief CMSIS Peripheral Access Layer for MIMX943_DDRC
 *
 * CMSIS Peripheral Access Layer for MIMX943
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX943_DDRC_H_)  /* Check if memory map has not been already included */
#define MIMX943_DDRC_H_
...
#endif  /* #if !defined(MIMX943_DDRC_H_) */
