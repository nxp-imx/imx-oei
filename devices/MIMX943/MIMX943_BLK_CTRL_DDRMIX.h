/*
** ###################################################################
**     Processors:          MIMX94333  Compilers:           GNU C Compiler
...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MIMX943_cm33
**
...
/*!
 * @file MIMX943_BLK_CTRL_DDRMIX.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for MIMX943_BLK_CTRL_DDRMIX
 *
 * CMSIS Peripheral Access Layer for MIMX943
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX943_BLK_CTRL_DDRMIX_H_)  /* Check if memory map has not been already included */
#define MIMX943_BLK_CTRL_DDRMIX_H_
...
#endif  /* #if !defined(MIMX943_BLK_CTRL_DDRMIX_H_) */
