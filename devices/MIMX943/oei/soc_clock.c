...
static struct clk_root_cfg clk_root_cfgs[] = {
	{ CLOCK_ROOT_DRAM_APB, CLOCK_SRC_SYSPLL1_PFD1_DIV2, 3 }, /* 400MHz / 3 = 133.(3) MHz */
#ifdef DEBUG
...
void Dram_Disable_Bypass(void)
{
	...
	(void) CCM_RootSetDiv(CLOCK_ROOT_DRAM_APB, 3U);
	(void) CCM_RootSetParent(CLOCK_ROOT_DRAM_APB, CLOCK_SRC_SYSPLL1_PFD1_DIV2);
	(void) CCM_RootSetEnable(CLOCK_ROOT_DRAM_APB, 1);
