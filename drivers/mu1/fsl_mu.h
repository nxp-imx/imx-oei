...
{
    kMU_GenInt0InterruptTrigger = 1U << 0U, /*!< General purpose interrupt 0. */
    kMU_GenInt1InterruptTrigger = 1U << 1U, /*!< General purpose interrupt 1. */
    kMU_GenInt2InterruptTrigger = 1U << 2U, /*!< General purpose interrupt 2. */
    kMU_GenInt3InterruptTrigger = 1U << 3U, /*!< General purpose interrupt 3. */
};
